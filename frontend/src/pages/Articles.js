...
export default function Articles() {
  ...
  return (
    <div>
        ...
        <ul className="grid grid-cols-3 gap-4 mt-4 px-10">
            {filteredResults.map((article, index) => (
                ...
                >
                    <img class="object-cover w-full h-38" src={article.image} alt="Flower and sky"/>
                    <h2 className="break-after-column text-blue-900"><br /><br />{article.headline}<br /><br /></h2>
