                 ...
                 <div className="w-full lg:w-1/2 xl:w-6/12 px-4">
                    <div className="max-w-[570px] mb-12 lg:mb-0">
                       ...
                       <p className="text-base text-body-color leading-relaxed mb-9">
                          I am an ex options trader turned software engineer. I built this
                          website to help people who are interns, new graduates, experienced,
                          or anyone who is just interested in getting a job in any area.
                          If you have anything in your mind that you would like to share
                        with me, please get in touch. This could be about computer science,
                        interviews, latest tech stack for website creation, finance, cool Python project ideas...
                       </p>
                       <div className="flex mb-8 max-w-[370px] w-full">
                          ...
                          <div className="w-full">
                             <h4 className="font-bold text-dark text-xl mb-1">My Location</h4>
                       ...
                       <div className="flex mb-8 max-w-[370px] w-full">
                          ...
                          <div className="w-full">
                             ...
                             <p className="text-base text-body-color">(+49)157 531 35 939</p>
                          </div>
                       </div>
                       <div className="flex mb-8 max-w-[370px] w-full">
                          <div
                          ...
                          <div className="w-full">
                             ...
                             <p className="text-base text-body-color">gokceozer123@gmail.com</p>
                          </div>
                       </div>
                    </div>
                 </div>
